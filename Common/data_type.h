...
const std::string raw_doc_dir=  "/home/viet/code/streaming_enron/";//streaming_syn_10_6/";//streaming_enron/";
...
#define ENTRY_VALUE_LEN 16 // 1024-bit
...
typedef std::unordered_map<int, std::unordered_set<long>> BF_value;
typedef std::unordered_map<int, int> Degree;
typedef std::unordered_set<int> PatternLabel;
